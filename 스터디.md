  ...
  <div class="row content">
    ...
    <div class="col-sm-4 sidenav">
		...
		<div class="fax_oneside">
		  <label><input type="radio" name="optradio" checked>단면</label>
		</div>
		<div class="fax_bothside">
		  <label><input type="radio" name="optradio">양면</label>
		</div>
    	<!-- 양면인쇄 end -->
    	...
    	<!-- 팩스진행도 end -->
		<!-- 팩스버튼을 누르면 진행도가 올라가도록 바꿀예정 -->
	    <button class="fax_bt">팩스</button>
	  </form>
          </div>
  </div>
</div>
...
### 앞으로 해야할 것
- 프린트의 결과값은 제대로 나오는데 원하는 곳에 안나옴
- 팩스의 진행도를 초당 10퍼씩 차도록하여 100퍼가 되면 전송완료 메시지를 띄우고 메인으로
