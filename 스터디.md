...
public class AController {	
	...
	public Object fax_ok(FaxVO fvo,  Model model) {
		System.out.println(fvo.getReciver());
		System.out.println(fvo.getFax_col());
		System.out.println(fvo.getFax_side());
		model.addAttribute("center","fax/fax_ok");
		return "main";
	}
...
```html
<h1>총 금액</h1>
<h2 th:text="'결제금액은 '+${session.printpay}+ ' 원 입니다.'"></h2>
```
### register
```html
<script>
